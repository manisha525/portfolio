...
export default function GemAI() {
  ...
  return (
   ...
   //   className="fixed bottom-5 right-5 z-[100] cursor-pointer bg-white dark:bg-gray-800 border border-blue-300 w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition"
        className="fixed bottom-[60px] right-[18px] z-[100] cursor-pointer w-[55px] h-[55px] rounded-full border border-blue-400 bg-white dark:bg-gray-900 shadow-lg hover:scale-105 transition flex items-center justify-center"
      ...
      {show && (
        <motion.div
          className="fixed bottom-[120px] right-[24px] z-[100] w-[357px] h-[550px] bg-white shadow-xl rounded-lg border border-gray-300 flex flex-col overflow-hidden"
