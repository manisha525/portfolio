...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title"> Manisha Shah
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home_description">Hi! I am Manisha Shah and I am an IT Engineer with advance skill of React JS. I am passionate about coding and dedicated to my work.</p>
